...
class Yolov7Publisher:
    def __init__(self, img_topic: str, weights: str, conf_thresh: float = 0.5,
        ...
        self.detected_obj_publisher = rospy.Publisher(
    ...
    def process_img_msg(self, img_msg: Image):
        ...
        if self.visualization_publisher:
            ...
            vis_img, detected_obj = draw_detections(np_img_orig, bboxes, classes,
                                      self.class_labels)
    ...
    def publish_detected_objects(self):
        if self.detected_obj_publisher and self.detected_obj:
            detected_obj_str = ",".join(self.detected_obj)
            self.detected_obj_publisher.publish(detected_obj_str)
...
if __name__ == "__main__":
    ...
    detected_obj_publisher = rospy.Publisher(
        "detected_objects", String, queue_size=1
    )
